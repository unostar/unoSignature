...
final class Plugin {
	public static function init(): void {
		load_plugin_textdomain('reality-maker', false, dirname(UNOSIGNATURE_BASENAME) . '/languages');
	...
	public static function woocommerce_missing_notice(): void {
		...
		echo esc_html__('unoSignature requires WooCommerce to be active.', 'reality-maker');
		echo '</p></div>';
	}
}
